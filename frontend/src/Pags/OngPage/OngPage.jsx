            ...
            <main className="min-h-screen min-w-screem bg-[#F4F0F0] // flex justify-center items-center">
                <section className="container p-4 md:p-8 max-w-6xl">
                        <div className="relative mb-4 text-gray-400">
                            ...
                            <input type="text" placeholder="Você tem interesse em uma ONG's específica, pesquise aqui..." className="w-full text-xs md:text-base p-3 pl-10 border border-gray-300 rounded-[4px] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"/>
                        </div>
