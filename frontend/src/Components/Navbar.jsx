...
function Navbar() {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      // Adicionado .closest('.navbar-container') para evitar fechar ao clicar em outros elementos da nav
  ...
  return (
    <header className="bg-white fixed top-0 w-full z-50 shadow-lg">
      {/* A altura original foi mantida com py-7 */}
      <nav className="flex items-center justify-between px-5 py-7 font-semibold mx-auto">
        ...
        <div className="hidden md:flex flex-grow justify-center pl-[170px]">
        ...
        <div className="hidden md:flex items-center justify-end gap-5 flex-shrink-0">
          {user ? (
            <div className="relative profile-menu-container flex items-center gap-5">
              {user && (
