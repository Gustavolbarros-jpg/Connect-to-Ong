...
function Footer({ variant = "default" }) {
  ...
  const footerClasses = isWhite
    ? "bg-[#F4F0F0] text-[#001449]"
    : "bg-blue-600 text-white";
  const paragraphClasses = isWhite ? "text-gray-600" : "text-gray-200";
  const linkClasses = isWhite
    ? "text-gray-600 hover:text-[#001449]"
      ...
      <div className="container mx-auto flex flex-col md:flex-row items-start gap-12 md:gap-20">
        ...
        <div className="flex flex-col items-start">
          ...
          <div className="flex flex-col items-start mt-4 space-y-3">
            <a
              href="https://boraimpactar.recife.pe.gov.br/"
              target="_blank"
              className={`${linkClasses} text-[20px]`}
            >
              Voluntariado e doação
            </a>
            <a
              href="https://boraimpactar.recife.pe.gov.br/blood_donations"
              target="_blank"
              className={`${linkClasses} text-[20px]`}
            >
              Doação de Sangue
            ...
            <a
              href="https://boraimpactar.recife.pe.gov.br/income_tax"
              target="_blank"
              className={`${linkClasses} text-[20px]`}
            >
              Imposto de Renda
            ...
            <a
              href="https://boraimpactar.recife.pe.gov.br/ngos"
              target="_blank"
              className={`${linkClasses} text-[20px]`}
            >
              Área da ONG
            ...
            <a
              href="https://boraimpactar.recife.pe.gov.br/events"
              target="_blank"
              className={`${linkClasses} text-[20px]`}
            >
              Agenda de eventos
